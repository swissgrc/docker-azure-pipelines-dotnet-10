# Docker image for running .NET 10 in an Azure Pipelines container job
...
This image can be used to run .NET 10 in [Azure Pipelines container jobs].
  ...
  - stage: deploy
    jobs:
      - deployment: runDotNet
        container: swissgrc/azure-pipelines-dotnet:10
...
| 10          | Identical to `latest` tag                       | ![Docker Image Size (tag)](https://img.shields.io/docker/image-size/swissgrc/azure-pipelines-dotnet/10?style=flat-square)          |
...
| 10-unstable | Identical to `unstable` tag                     | ![Docker Image Size (tag)](https://img.shields.io/docker/image-size/swissgrc/azure-pipelines-dotnet/10-unstable?style=flat-square) |
